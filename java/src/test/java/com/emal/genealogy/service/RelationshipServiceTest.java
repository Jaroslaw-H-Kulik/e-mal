...
class RelationshipServiceTest {
    ...
    private static Map<String, Object> payload(String basePersonId, String targetPersonId, String relType, String role) {
        Map<String, Object> p = new LinkedHashMap<>();
        p.put("base_person_id", basePersonId);
        p.put("target_person_id", targetPersonId);
        p.put("relationship_type", relType);
        p.put("role", role);
        return p;
    }
    ...
    void missingRoleKeyFailsCleanly(@TempDir Path tempDir) throws IOException {
        ...
        payload.put("base_person_id", NO_BIRTH_EVENT_CHILD);
        payload.put("target_person_id", UNRELATED_FEMALE);
        payload.put("relationship_type", "parent");
