...
public sealed interface AddRelationshipResult {
    ...
    record Success(boolean success, String createdEvent, String updatedEvent, String message)
            implements AddRelationshipResult {
        public Success(String createdEvent, String updatedEvent, String message) {
            this(true, createdEvent, updatedEvent, message);
        }
    }
